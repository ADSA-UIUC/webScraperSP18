...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Hi! Please tell me where you would like top news from, " \
                    "with give me top headlines from CNN."
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Please tell me where you would like top news from, " \
                    "with give me top headlines from CNN."
...
def get_headlines(intent, session):
    ...
    if 'NewsSource' in intent['slots']:
        source = intent['slots']['NewsSource']['value']
        speech_output = create_headings_response(source)
